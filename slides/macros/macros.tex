...
\newcommand{\setLectureBasic}[1]{
  ...
  \author{\textbf{Jos\'{e} Proen\c{c}a} \and Pedro Ribeiro}
  \institute{CISTER -- U.Porto, Porto, Portugal
            \hfill 
            \begin{tabular}{r@{}}
            \url{https://fm-dcc.github.io/alg2425}
            \end{tabular}
            }
  \date{Algorithms (CC4010) 2024/2025}
...
\includepdf[pages=#2]{../../../Alg2324/others/#3}
}}
